    ...
    <footer className="bg-white border-t-2 border-[#004080] text-[#004080]   py-3 text-sm  w-full">
      <div className="w-[90%] mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-green-400 font-mono text-lg bg-black inline-block px-2 py-1 rounded">003925103</p>
          <p className="mt-2 text-gray-600"><span className=" text-black font-semibold">Your IP:</span> 106.222.215.47</p>
          <p className="text-red-500">Will Be Monitored For Security Purpose</p>
        </div>
